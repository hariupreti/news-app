...
export default function CenterNews() {
    ...
    <div className=''>
        ...
        <h1 className='text-xl mt-8 mb-4 font-semibold text-gray-500'>Technology around world</h1>
        {
            breakingNews && breakingNews.length > 0 ?
            <div className="grid lg:grid-cols-12 gap-1">
            <div className="lg:col-span-6 md:col-span-6"><EachNews news={breakingNews[13]}></EachNews></div>
            <div className="lg:col-span-6 md:col-span-6"><EachNews news={breakingNews[14]}></EachNews></div>
            <div className="lg:col-span-4 md:col-span-6"><EachNews news={breakingNews[15]}></EachNews></div>
            <div className="lg:col-span-4 md:col-span-6"><EachNews news={breakingNews[16]}></EachNews></div>
            <div className="lg:col-span-4 md:col-span-6"><EachNews news={breakingNews[17]}></EachNews></div>
            <div className="lg:col-span-8 md:col-span-6 "><EachNews news={breakingNews[18]}></EachNews></div>
            <div className="lg:col-span-4 md:col-span-6"><EachNews news={breakingNews[19]}></EachNews></div>
            <div className="lg:col-span-5 md:col-span-6 "><EachNews news={breakingNews[20]}></EachNews></div>
            <div className="lg:col-span-7 md:col-span-6"><EachNews news={breakingNews[21]}></EachNews></div>
            </div>
            : <Loading></Loading>
        }
    </div>
