...
export default function NewsOnImageBackground({news}) {
    ...
    return (
    <div className={`min-h-[400px] border-4 border-white rounded-lg cursor-pointer opacity-90 hover:opacity-100`}>
        <img src={backgroundImage} className="w-full h-70 rounded-md"></img>
        <div className='-mt-80'>
